...
export const columns = (
  setOrderState: React.Dispatch<
    React.SetStateAction<ServiceOrderWithService[]>
  >,
  orderState: ServiceOrderWithService[]
): ColumnDef<ServiceOrderWithService>[] => [
  {
    id: "buyer",
  ...
  },
  {
    ...
    header: () => <div className="mx-1">Actions</div>,
    size: 1,
    cell: ({ row }) => {
      return (
        <IncomingActionsDialog
          order={row.original}
          setOrders={setOrderState}
