...
import { Pagination } from "@/app/(organization)/dashboard/orders/[id]/_components/MessagePagination";
...
import { completeOrder } from "@/utils/functions/service_orders/serviceOrderActions";
            ...
            <div className="flex">
              ...
              <div className="flex ml-auto space-x-4">
                ...
                <Button
                  ...
                  onClick={async () => {
                    await completeOrderClient();
                  }}
                  disabled={loading} // Disable the button while loading
                >
                  {loading ? (
                    <Loader2 className="animate-spin" /> // Show the loading spinner
                  ) : (
                    "Mark as complete"
                  )}
                </Button>
